export default function handler(req, res) {
    ...
    const danhSachToanHuyen = [
        ...
        { xa: "Tản Lĩnh", thon: ["Yên Thành", "Cua Chu", "Việt Long", "Hiệu Lực", "Bát Đầm", "Cẩm Phương", "Mỹ Đức", "Hát Giang", "Tam Mỹ"] },
        { xa: "Vân Hòa", thon: ["Bặn", "Muồng Phú Vàng", "Muồng Cháu", "Đa Cuống"] },
        { xa: "Yên Bài", thon: ["Chóng", "Mít", "Quýt", "Bài"] },
        { xa: "Khánh Thượng", thon: ["Khánh Chúc", "Chẹ", "Gò Đình Muôn", "Thôn Hương"] },
        { xa: "Minh Quang", thon: ["Đá Chông", "Minh Hồng", "Đồng Tâm"] },
